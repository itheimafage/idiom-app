...
const config: UserConfigExport = {
  ...
  defineConstants: {
    ...
    TARO_APP_OFFLINE: JSON.stringify(process.env.TARO_APP_OFFLINE || 'false'),
  },
  copy: {
    patterns: [
      // 小程序构建时复制 project.config.json 到输出目录
      { from: 'project.config.json', to: 'dist/project.config.json', ignore: [] }
    ],
    options: {}
  },
  framework: 'react',
